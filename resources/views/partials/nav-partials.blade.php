...
<nav class="navbar fixed-top navbar-default" style="background-color:#32CD99">
    <div class="col-xs-6">
        <a href="{{ route('home')}}"><img alt="logo" class="img-fluid" src="{{ asset('img/Logo.png') }}" style="width: 50px;height:45px"></a>
    </div>
    ...
    <div class="col-xs-6" style=" margin-right: 10px;">
        ...
        @else
            <div class="row">
                <a style="text-decoration:none" href="{{ route('home')}}"> <h4 class="mt-2 mr-2 text-white">{{ $user -> name }}</h4></a>
